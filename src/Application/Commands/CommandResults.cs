...
public record CommandSuccess<T>(T Data) where T : class;
...
{
    public OpenAccountCommandResult(OneOf<CommandSuccess<OpenAccountResult>, CommandFailure> input) : base(input) { }
    
    public static implicit operator OpenAccountCommandResult(CommandSuccess<OpenAccountResult> success) => new(success);
    public static implicit operator OpenAccountCommandResult(CommandFailure failure) => new(failure);
}

public class DepositCommandResult : OneOfBase<CommandSuccess<DepositResult>, CommandFailure>
{
    public DepositCommandResult(OneOf<CommandSuccess<DepositResult>, CommandFailure> input) : base(input) { }
    
    public static implicit operator DepositCommandResult(CommandSuccess<DepositResult> success) => new(success);
...
{
    public WithdrawCommandResult(OneOf<CommandSuccess<WithdrawResult>, CommandFailure> input) : base(input) { }
    
    public static implicit operator WithdrawCommandResult(CommandSuccess<WithdrawResult> success) => new(success);
...
{
    public TransferCommandResult(OneOf<CommandSuccess<TransferResult>, CommandFailure> input) : base(input) { }
    
    public static implicit operator TransferCommandResult(CommandSuccess<TransferResult> success) => new(success);
